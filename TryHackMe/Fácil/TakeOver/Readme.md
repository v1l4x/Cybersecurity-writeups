...
Esta es la primera máquina que resuelvo, llamada Takeover, catalogada como fácil. Y sinceramente, lo es… pero solo si prestas atención a los detalles.
...
```bash
gobuster vhost -w /usr/share/seclists/Discovery/DNS/subdomains-top1million-5000.txt -u futurevera.thm -t 50 -o subdomains --append-domain
```
**Resultado obtenido:**
