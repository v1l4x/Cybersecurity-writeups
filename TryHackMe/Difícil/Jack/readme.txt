...
✅ Conclusión
La máquina Jack demuestra cómo una cadena de errores (contraseñas débiles, backups expuestos y permisos de escritura en librerías del sistema) puede llevar a un compromiso total. El Python Library Hijacking es un vector sutil pero devastador en entornos con permisos mal configurados.
Exposición de GIT: Información crítica en el historial de versiones.

Lógica Vulnerable: Escalada basada en entender cómo funciona la aplicación.
